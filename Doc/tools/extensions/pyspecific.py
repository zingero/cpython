...
pydoc_topic_labels = [
    ...
    'decr', 'del', 'dict', 'dynamic-features', 'else', 'exceptions', 'execmodel',
    'exprlists', 'floating', 'for', 'formatstrings', 'function', 'global',
    'id-classes', 'identifiers', 'if', 'imaginary', 'import', 'in', 'incr',
    'integers', 'lambda', 'lists', 'naming', 'nonlocal', 'numbers', 'numeric-types',
